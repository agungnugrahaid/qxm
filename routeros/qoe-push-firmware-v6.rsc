# qoe-push-firmware-v6.rsc
#
# v6 variant: identical to qoe-push-firmware-v7.rsc except the config
# export. v7's `show-sensitive` flag does not PARSE on RouterOS 6 --
# and isn't needed: v6 includes sensitive values in `/export` by
# default (v7 inverted that default, which is why the flag exists).
#
...
# masks sensitive values in the export.
#
